...
import com.github.crashdemons.mobeggdrops.compatibility.faketestserver_1_0.Provider;
...
public class CompatibilityTest {
    ...
    public void testIsProviderAvailable() {
        ...
        for(HashMap.Entry<String, Integer[][]> entry : CompatibilitySupport.VERSIONS.entrySet()){
