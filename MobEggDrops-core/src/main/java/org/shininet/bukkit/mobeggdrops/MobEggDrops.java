...
import com.github.crashdemons.mobeggdrops.api.ApiProvider;
import com.github.crashdemons.mobeggdrops.compatibility.Compatibility;
import com.github.crashdemons.mobeggdrops.compatibility.CompatiblePlugins;
import com.github.crashdemons.mobeggdrops.compatibility.Version;
import com.github.crashdemons.mobeggdrops.compatibility.exceptions.CompatibilityUnavailableException;
import com.github.crashdemons.mobeggdrops.compatibility.exceptions.CompatibilityUnsupportedException;
import com.github.crashdemons.mobeggdrops.compatibility.exceptions.UnknownVersionException;
...
public final class MobEggDrops extends JavaPlugin implements Listener,MobEggDropsPlugin {

    private MobEggDropsListener listener;
    ...
    public void onEnable() {
        ...
        listener = new MobEggDropsListener(this);
        MobEggDropsCommandExecutor commandExecutor = new MobEggDropsCommandExecutor(this);
        ...
        PluginCommand command = getCommand("MobEggDrops");
