...
import com.github.crashdemons.mobeggdrops.compatibility.CompatibilitySupport;
    ...
    public void testSupport(){
        ...
        for(Map.Entry<String,Integer[][]> serverSupport : CompatibilitySupport.VERSIONS.entrySet()){
            ...
            for (Integer[] serverVer : serverVers) {
                ...
                String classPath="com.github.crashdemons.mobeggdrops.compatibility."+packagename;
